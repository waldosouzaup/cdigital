...
const SELECAO_CONTRATO =
  "id, pessoa_id, objeto, valor, valor_extenso, vigencia_inicio, vigencia_fim, status, canal_envio, enviado_para, caminho_pdf, pessoas ( nome_completo, cpf ), regioes ( nome )";
